...
if ${onlineMode}; then
	...
	echo
        ...
        if [[ ${rewardsEntryCnt} -gt 0 ]]; then #address already registered, lets show the info we have about it

		echo -e "${iconYes} \e[0mStaking Address is \e[32malready registered\e[0m on the chain with a deposit of \e[32m${keyDepositFee}\e[0m lovelaces :-)\n";
