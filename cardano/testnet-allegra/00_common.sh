...
genesisfile="configuration-testnet/allegra-shelley-genesis.json"           #Shelley-Genesis path
genesisfile_byron="configuration-testnet/allegra-byron-genesis.json"       #Byron-Genesis path
...
magicparam="--testnet-magic 12"	#choose "--mainnet" for mainnet or for example "--testnet-magic 1097911063" for a testnet, 12 for allegra
addrformat="--testnet-magic 12" #choose "--mainnet" for mainnet address format or like "--testnet-magic 1097911063" for testnet address format, 12 for allegra
...
byronToShelleyEpochs=1 #208 for the mainnet, 74 for the testnet, 1 for allegra-testnet
