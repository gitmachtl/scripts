...
minCliVersion="8.20.3"  		#minimum allowed cli version for this script-collection version
maxCliVersion="99.99.9"  		#maximum allowed cli version, 99.99.9 = no limit so far
minNodeVersion="8.8.1"  		#minimum allowed node version for this script-collection version
